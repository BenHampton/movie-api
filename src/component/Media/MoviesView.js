            ...
            <div className={'p-grid dataview-listItem'} style={{marginLeft: '10px'}}>
                ...
                <div className={'p-col-9'}>
                    <div className={'list-text-container'}>
                        <div className={'movies-list-text'}>Title: <b>{movie.title}</b></div>
                        <div className={'movies-list-text'}>Rating: <b></b></div>
                        <div className={'movies-list-text'}>Genre: <b>{movie.genre_ids}</b></div>
                        <div className={'movies-list-text'}>Stars: <b>{movie.vote_average}</b></div>
                        <div>
                            <div className={'movies-list-text'}>
                                Overview:
                            </div>
                            <div className={"overview-container"}>
                                <ScrollPanel className={"list-overview-scrollPane"}>
                                    <div className={'movies-overview-text'}>
                                        <b>{movie.overview}</b>
                                    </div>
                                </ScrollPanel>
                            </div>
